...
ORDER: list[str] = [
    ...
    "extract-apply-torch-tp-move",
    "extract-init-threads-binding-prep",
    "extract-init-threads-binding-move",
    "inline-max-pool-size",
    "extract-prealloc-symm-pool-prep",
    "extract-prealloc-symm-pool-move",
    "extract-kv-cache-dtype-prep",
    "extract-kv-cache-dtype-move",
    "introduce-weight-updater",
    "wu-move-from-disk-prep",
    "wu-move-from-disk-move",
    "wu-move-from-distributed-prep",
    "wu-move-from-distributed-move",
    "wu-move-from-tensor-prep",
    "wu-move-from-tensor-move",
    "wu-move-from-ipc-prep",
    "wu-move-from-ipc-move",
    "introduce-weight-exporter",
    "we-move-save-get-prep",
    "we-move-save-get-move",
    "extract-update-expert-location-prep",
    "extract-update-expert-location-move",
    "extract-init-device-graphs-prep",
    "extract-init-device-graphs-move",
    "extract-piecewise-cuda-graphs-prep",
    "extract-piecewise-cuda-graphs-move",
    "extract-hybrid-arch-props",
    "drop-hybrid-arch-delegates",
    "extract-autotune-helpers-prep",
    ...
    "rwt-migrate-register-bootstrap-prep",
    "rwt-migrate-register-bootstrap-move",
    "rwt-migrate-modelexpress-publish-prep",
    "rwt-migrate-modelexpress-publish-move",
    "introduce-ngram-embedding-mgr",
    "nem-migrate-maybe-prepare-prep",
    "nem-migrate-maybe-prepare-move",
    ...
    "kvc-extract-mla-dim-prep",
    "kvc-extract-mla-dim-move",
    "kvc-migrate-leaves",
