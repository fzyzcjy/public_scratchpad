#!/usr/bin/env python3
"""Build tom_refactor_202605a/primary/nonmech_scheduler from `<id>.py` scripts.

Stacked on `mech_scheduler`. Identical orchestration shape to
...
WT = Path("/tmp/refactor-wt-nonmech-scheduler")
BASE = "tom_refactor_202605a/primary/mech_scheduler"
CHAIN_BRANCH = "tom_refactor_202605a/primary/nonmech_scheduler"
