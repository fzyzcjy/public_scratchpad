#!/usr/bin/env python3
"""Build tom_refactor_202605a/primary/nonmech_tokenizer_manager from `<id>.py` scripts.

Stacked on `mech_tokenizer_manager`. Identical orchestration shape to
`_build_nonmech_model_runner.py` — see that file for full docs.
...
WT = Path("/tmp/refactor-wt-nonmech-tokenizer-manager")
BASE = "tom_refactor_202605a/primary/mech_tokenizer_manager"
CHAIN_BRANCH = "tom_refactor_202605a/primary/nonmech_tokenizer_manager"
