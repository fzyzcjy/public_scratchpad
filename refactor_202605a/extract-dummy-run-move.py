...
``model_executor/model_runner_components/dummy_run.py``. Body byte-equivalent. The lambda callback
...
SUBJECT = "Move dummy_run to model_executor.model_runner_components.dummy_run (cut+paste)"
BODY = ""
...
def transform(wt: Path) -> None:
    ...
    dr = wt / "python/sglang/srt/model_executor/model_runner_components/dummy_run.py"
    ...
    text = insert_after(
        ...
        addition="from sglang.srt.model_executor.model_runner_components.dummy_run import dummy_run\n",
    )
    mr.write_text(text)
